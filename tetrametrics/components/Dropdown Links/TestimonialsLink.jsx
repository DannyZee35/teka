...
const TestimonialsLink = ({TestimonialsClick}) => {
      ...
      <div ref={dropdownRef} className="absolute mt-4 bg-white text-black border p-10 w-[800px] border-gray-300 rounded-md block left-1/4 transform -translate-x-1/4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            Discover how client success has been realized through detailed case studies.            </p>
          </div>
          <div className="flex flex-col">
            <span className="flex items-center gap-3">
              <Link href={"/cases"} onMouseEnter={() => setIconHovered(true)} onClick={TestimonialsClick} onMouseLeave={() => setIconHovered(false)}>Case Studies</Link>
