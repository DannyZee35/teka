  ...
  return (
    <>
      {isMobile ? (
        ...
        <>
          <nav className={`flex items-center z-50 justify-between p-5 text-black font-mont font-semibold ${isHome ? "text-white" : "text-black"}`}>
            <div className="pb-4">
            ...
            <div className="flex gap-10 z-50">
              ...
              <ResourcesLink ResourcesClick={() => setIsHome(false)} />
              <TestimonialsLink TestimonialsClick={() => setIsHome(false)}/>
            </div>
            <div className="pb-4">
              <Button
               ...
               onClick={() => { setIsHome(false); router.push('/request-demo'); }}
